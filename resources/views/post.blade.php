                ...
                <div class="sticky-content-inner">
                    ...
                    <div class="comment--list pd--30-0">
                        ...
                        <div class="post--items-title">
                            <h2 class="h4"><span class="post_count_comment h4">{{ count($post->comments) }} </span> bình
                                luận</h2>
                            ...
                            <li>
                                ...
                                <div class="comment--item clearfix">
                                    <div class="comment--img float--left">
                                        <img src="{{ $comment->user->image ? asset('storage/' . $comment->user->image->path) : asset('storage/placeholders/user_placeholder.jpg') }}"
                                    ...
                                    <div class="comment--info">
                                        <div class="comment--header clearfix">
                                            ...
                                            <p class="date">{{ $comment->created_at->locale('vi')->diffForHumans() }}
                                            </p>
                        ...
                        <div class="comment-respond">
                            ...
                            <form onsubmit="return false;" autocomplete="off" method="POST">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <textarea name="the_comment" id="message" cols="30" rows="5"
                                            class="form-control" placeholder="Đánh giá bài viết này"></textarea>
                                    </div>
                                </div>
